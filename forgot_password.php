                ...
                <div class="box"><!-- box Begin -->
                    ...
                    <div class="box-header"><!-- box-header Begin -->
                        ...
                        <center><!-- center Begin -->
                            ...
                            <p> Vui lòng nhập địa chỉ email, số điện thoại di động hoặc tên người dùng của bạn để tìm kiếm tài khoản của bạn. </p>
                        ...
                        <form action="forgot_password.php" method="post"><!-- form Begin -->
                            ...
                            <div class="form-group"><!-- form-group Begin -->
                                ...
                                <label>Email, số điện thoại di dộng hoặc tên người dùng</label>
                                
                                <input type="text" class="form-control" name="c_search" required value="<?php if(isset($_POST['c_search']) && $_POST['c_search'] != NULL){ echo $_POST['c_search']; } ?>">
