    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Bảng điều khiển / Cập nhật loại sản phẩm
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-pencil fa-fw"></i> Cập nhật loại sản phẩm
                ...
                <form action="" class="form-horizontal" method="post"><!-- form-horizontal begin -->
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <input value="Cập nhật loại sản phẩm" name="update" type="submit" class="form-control btn btn-primary">
...
<?php  
          ...
          if(isset($_POST['update'])){
              ...
              if($run_cat){
                  ...
                  echo "<script>alert('Loại sản phẩm đã được cập nhật')</script>";
