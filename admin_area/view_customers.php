                    ...
                    <table class="table table-striped table-bordered table-hover"><!-- table table-striped table-bordered table-hover begin -->
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <!-- <td> <img src="customer\customer_images\AnhConGai1.jpg" width="60" height="60"></td> -->
                                <!-- <td> <?php echo "<img src='../customer/customer_images/AnhConGai1.jpg' width='60' height='60'>";?></td> -->
                                <!-- <td><?php echo "<img src = 'CoGiaoVatLy.jpg' alt='CoGiaoVatLy.jpg' width='60' height='60'/>"; ?></td> -->
