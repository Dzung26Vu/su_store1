                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                    ...
                    <div class="form-group"><!-- form-group Begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 Begin -->
                            ...
                            <input name="admin_pass" type="password" class="form-control" required value="<?php if(isset($_POST['admin_pass']) && $_POST['admin_pass'] != NULL){ echo $_POST['admin_pass']; } ?>">
                    ...
                    <div class="form-group"><!-- form-group Begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 Begin -->
                            ...
                            <input name="admin_pass2" type="password" class="form-control" required value="<?php if(isset($_POST['admin_pass2']) && $_POST['admin_pass2'] != NULL){ echo $_POST['admin_pass2']; } ?>">
