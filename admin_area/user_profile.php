                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                    ...
                    <div class="form-group"><!-- form-group Begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 Begin -->
                            ...
                            <input value=""  name="admin_pass" type="text" class="form-control" required>
...
if(isset($_POST['update'])){
    ...
    if(is_uploaded_file($_FILES['admin_image']['tmp_name'])){
        ...
        $update_user = "update admins set admin_name='$user_name',admin_username='$user_email',admin_pass='$user_pass',admin_address='$user_country',admin_contact='$user_contact',admin_job='$user_job',admin_about='$user_about',admin_image='$user_image' where admin_id='$user_id'";
        ...
        $update_user = "update admins set admin_name='$user_name',admin_username='$user_email',admin_pass='$user_pass',admin_address='$user_country',admin_contact='$user_contact',admin_job='$user_job',admin_about='$user_about' where admin_id='$user_id'";
