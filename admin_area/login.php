...
<div class="container"><!-- container begin -->
       <form action="" class="form-login" method="post"><!-- form-login begin -->
           ...
           <input type="password" class="form-control" placeholder="Mật khẩu Admin" name="admin_pass" required value="<?php if(isset($_POST['admin_pass']) && $_POST['admin_pass'] != NULL){ echo $_POST['admin_pass']; } ?>">
