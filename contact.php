                    ...
                    <div class="box-header"><!-- box-header Begin -->
                        ...
                        <form action="contact.php" method="post"><!-- form Begin -->
                            ...
                            <div class="form-group"><!-- form-group Begin -->
                                ...
                                <input type="text" class="form-control" name="name" required value="<?php if(isset($_POST['name']) && $_POST['name'] != NULL){ echo $_POST['name']; } ?>">
                            ...
                            <div class="form-group"><!-- form-group Begin -->
                                ...
                                <input type="text" class="form-control" name="email" required value="<?php if(isset($_POST['email']) && $_POST['email'] != NULL){ echo $_POST['email']; } ?>">
