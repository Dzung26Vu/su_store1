                    ...
                    <div class="box-header"><!-- box-header Begin -->
                        ...
                        <form action="change_password_forgot.php" method="post"><!-- form Begin -->
                            ...
                            <div class="form-group"><!-- form-group Begin -->
                                ...
                                <input type="password" class="form-control" minlength="8" name="new_pass" required value="<?php if(isset($_POST['new_pass']) && $_POST['new_pass'] != NULL){ echo $_POST['new_pass']; } ?>">
                            ...
                            <div class="form-group"><!-- form-group Begin -->
                                ...
                                <input type="password" class="form-control" minlength="8" name="new_pass_again" required value="<?php if(isset($_POST['new_pass_again']) && $_POST['new_pass_again'] != NULL){ echo $_POST['new_pass_again']; } ?>">
