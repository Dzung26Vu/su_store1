                ...
                <div class="box"><!-- box Begin -->
                    ...
                    <div class="box-header"><!-- box-header Begin -->
                        ...
                        <center><!-- center Begin -->
                            ...
                            <h2> Nhập mã bảo mật </h2> <?php // echo $code_sent ?>

                            <p> Vui lòng kiểm tra email để tìm tin nhắn có mã của bạn. Mã của bạn dài 6 số. </p>
                        ...
                        <form action="confirm_mail_forgot_password.php" method="post"><!-- form Begin -->
                            ...
                            <div class="form-group"><!-- form-group Begin -->
                                ...
                                <label> Nhập mã 6 chữ số chúng tôi vừa gửi vào email của bạn </label>
